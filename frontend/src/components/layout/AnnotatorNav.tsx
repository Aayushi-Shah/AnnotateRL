...
import { ClipboardList, ListTodo, LogOut } from "lucide-react";
...
const navItems = [
  { href: "/annotator/queue", label: "Task Queue", icon: ListTodo },
  { href: "/annotator/my-tasks", label: "My Tasks", icon: ClipboardList },
];
  ...
  return (
    <aside className="w-56 shrink-0 border-r border-border bg-card h-screen flex flex-col">
      ...
      <div className="p-3 border-t border-border">
        ...
        <Button variant="ghost" size="sm" className="w-full justify-start gap-3 text-muted-foreground mt-1" onClick={handleLogout}>
